...
@section('content')
    <section class="rounded-3xl bg-gradient-to-r from-slate-950 to-blue-950 text-white p-8 md:p-10 mb-8">
        <p class="text-xs font-bold uppercase tracking-[0.2em] text-sky-300">Contact ZNY LOGISTICS</p>
